...
<div class="navigation">
	...
	<a class="current" href="addActor.php">Add Actor</a>
...
<?php
	...
	$sql="INSERT INTO Actor(actName) VALUES ('$actorQuery')";
	...
	if($num > 0)
	{
		...
		echo "<br>Actor Added<br><br>";
	}
	else
	{
		//else prints out error message with css styling
		echo '<div class="confirmation">';
		echo "<br><c>Error:</c>Actor Couldn't Be Added<br><br>";
		echo '</div>';
	}
	}
